...
//function for barchart,gauge
function buildChart(sample) {
    d3.json("samples.json").then((data) => {

    var metadata = data.metadata;
    var arrayResult1 = metadata.filter(sampleObj => sampleObj.id == sample);
    var Result1 = arrayResult1[0];
    //var wFreq = Result1.wfreq.map((value) => parseInt(value));
    var wFreq = parseInt(Result1.wfreq); 
        console.log(wFreq);
